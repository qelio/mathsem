...
//    }
    ...
    connect(ui->LangChange, &QComboBox::currentTextChanged, [=](const QString &str) {
        bool loaded = mainTranslator.load(QString(":/lang/translations/mainwindow_") + str + QString(".qm"));
        qDebug() << loaded;
